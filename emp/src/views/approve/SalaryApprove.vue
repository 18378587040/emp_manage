...
<script>
    export default {
        ...
        methods: {
            agree(id) {
                this.putRequest("/api/admin/approve/transsalary/?id="+ id + '&status=1')
                    .then((data) => {
                        if (data) {
                            this.listTransSalarys();
                        }
            ...
            refuse(id) {
                this.putRequest("/api/admin/approve/transsalary/?id="+ id + '&status=2')
                    .then((data) => {
                        if (data) {
                            this.listTransSalarys();
                        }
            ...
            openModel(TransSalary) {
                if (TransSalary != null) {
                    ...
                    this.$refs.TransSalaryTitle.innerHTML = "编辑调动";
                } else {
                    this.TransSalaryForm.name = "";
                    this.TransSalaryForm.reason = "";
                    this.TransSalaryForm.afterSalary = "";
                    this.TransSalaryForm.beforeSalary = "";
                    this.$refs.TransSalaryTitle.innerHTML = "调动申请";
                }
                this.addOrEdit = true;
            },
            addOrEditCategory() {
